...
/**
 * Interface command, according to the command pattern. It will be used to assign commands in a list of commands for each specials
...
public interface Command {
    ...
    /**
     * Method execute which will execute the command by using methods of the element. "Only" specials elements will
