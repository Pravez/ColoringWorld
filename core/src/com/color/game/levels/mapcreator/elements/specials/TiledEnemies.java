...
public class TiledEnemies extends TiledDynamicElements{
    ...
    private void createBodies(){
        for(MapObject object : this.objects){
            if(object instanceof RectangleMapObject){
                ...
                ElementColor color = object.getProperties().get("color") != null ? ElementColor.parseString((String) object.getProperties().get("color")) : null;
